...
void ShowMessage(NSString *message) {
    ...
    if (![NSThread isMainThread]) {
        dispatch_async(dispatch_get_main_queue(), ^{
            MBProgressHUD *hud = baseHUDView(DefalutWindow(), KCOLOR_3);
...
/**
 ...
 @param completed  完成回调
 */
void PerformCustomHUDMethod(MBProgressHUD *hud,NSString *message,NSString *imageNamed,void(^completed)(void)) {
