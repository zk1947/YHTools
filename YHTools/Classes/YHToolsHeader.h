...
#define KIMGV(imgv,imgName) [imgv sd_setImageWithURL:[NSURL URLWithString:imgName] placeholderImage:KIMAGE(@"mine-head")]
...
//常用颜色
#define KCOLOR_ZT  [UIColor colorWithHexString:@"#E76962"]      //主题色
